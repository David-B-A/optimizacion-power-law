...
Mean = append(Mean, NA, after = length(Mean))
SD = append(SD, NA, after = length(SD))
Median = append(Median, NA, after = length(Median))
SD_Median = append(SD_Median, NA, after = length(Mean))
...
grienwank = data.frame(Metodo,Mean,SD,Median,SD_Median)